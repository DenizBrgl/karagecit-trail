    ...
    <div className="pt-24 px-4 mt-10 md:px-20 py-10 text-gray-800 bg-white flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl text-left">
        ...
        <p className="mb-4">
          ...
          ormanların içinden geçerken, iniş ve çıkışlarla dolu bu parkur, hem
          fiziksel hem de zihinsel sınırlarınızı zorlayacak. Doğayla iç içe,
          serin ve gölgeli yollarda unutulmaz bir deneyim sizi bekliyor!
        </p>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            Göğüs numarası (Görünür biçimde vücuda iliştirilmiş olmalı,
            numaranın asla orijinal boyutu değiştirilmemelidir.)
          </li>
          <li>Kimlik</li>
          <li>Cep telefonu</li>
