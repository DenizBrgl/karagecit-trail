  ...
  return (
    <div className="pt-24 px-4 mt-10 md:px-20 py-10 text-gray-800 bg-white flex flex-col items-center">
      ...
      <div className="w-full max-w-4xl text-left">
        ...
        <p className="mb-4">
          Yaklaşık uzunluğu 8 km ve 407 yükseklik kazanımı olan Kadıncık
          Discovery Run parkuru %70 patika, %20 single track ve %10 asfalt
          yoldan oluşmaktadır. Mesafe olarak kısa ancak yarış genelinin 400
          metrenin üzerinde geçmesinden dolayı hissedilen zorluk seviyesi orta
          olacaktır.
        </p>
        <p className="mb-4">
          31 Ağustos Pazar sabahı saat 09.00‘da baraj köprüsünden start alacak,
          ilk CP noktasından geri dönüş olacak şekilde aynı yerde finish
          yapacaktır.
        </p>
        ...
        <p className="mb-4">
          ...
          tanınacak olan toplam süre 2 saattir. 8K KADINCIK DISCOVERY RUN
          parkurunda 1 adet CP noktası bulunmaktadır.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          8K Kadıncık Discovery Run koşusuna kayıt olan katılımcılar, koşu
